Find the installed poteto-mode skill and read references/pstack-runtime.md first. Skill names resolve from the installed skill catalog; if absent, use .agents/skills in the project or home directory.
