---
name: control-ui
description: Verify a running browser, desktop, or mobile UI using available
  automation, with observed state and screenshots. Use when pstack requires
  runtime evidence on a visual surface.
license: MIT
---
