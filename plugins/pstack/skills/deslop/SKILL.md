---
name: deslop
description: Review a scoped code diff for unnecessary abstractions, redundant
  guards, inconsistent style, and generated-code clutter. Use when asked to
  deslop code or when pstack routes a pre-commit cleanup.
license: MIT
---
