---
name: control-cli
description: Verify actual CLI or terminal UI behavior through the available shell or PTY, capturing commands, results, and observable state. Use when pstack needs runtime proof on a command-line surface.
