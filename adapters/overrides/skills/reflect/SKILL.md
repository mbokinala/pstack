---
name: reflect
description: Review the current conversation through judgment, tooling, and divergent lenses, then propose durable improvements to the skills it used. Use when the user says reflect.
