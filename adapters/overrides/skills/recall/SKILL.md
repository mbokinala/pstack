---
name: recall
description: "Reconstruct recent working context from available project-scoped chat history, live state, and relevant shared records, then return a current-state brief. Use for recall my work on X, catch me up, what have I been working on, or where did I leave off."
